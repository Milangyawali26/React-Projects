  ...
  return (
    ...
    >
      ...
      <div className="text-center z-10 px-4">
        <h1 className="tetx-5xl md:text 7xl font-bold mb-6 bg-gradient-to-r from-blue-500 to-purple-600 bg-clip-text text-transparent  leading-right">
          Hi, I'm Milan Gyawali
        </h1>
        <p className="text-grey-400 text-lg mb-8 max-w-lg mx-auto ">
          ...
          experience working with React, Node.js, and Express.
        </p>
        ...
        <div className="flex justify-center space-x-4">
          ...
          <a
            href="#contact"
            className=" border border-blue-500 text-blue-500 py-3 px-6 rounded font-medium transition-all duration-200 relative
